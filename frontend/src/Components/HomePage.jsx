...
const HomePage = () => {
  ...
  const handleSearch = (e) => {
    ...
    if (selectedDestination && checkInDate && checkOutDate) {
      alert(`Searching for ${guests} guests in ${selectedDestination} from ${checkInDate} to ${checkOutDate}`);
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p className="hero-subtitle">
              Explore breathtaking locations, find amazing hotels, and plan your next adventure with DreamCation
            </p>
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>Discover handpicked luxury accommodations with world-class amenities and exceptional service.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">✈️</div>
              <h3>Easy Booking</h3>
              <p>Simple and secure booking process with instant confirmation and flexible cancellation options.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">🗺️</div>
              <h3>Curated Destinations</h3>
              <p>Explore carefully selected destinations with insider tips and local recommendations.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">💎</div>
              <h3>Exclusive Deals</h3>
              <p>Access to special rates and exclusive packages not available elsewhere.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cta">
        <div className="container">
          <div className="cta-content">
            ...
            <p>Join thousands of travelers who trust DreamCation for their perfect vacation</p>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-section">
              <h3>DreamCation</h3>
              <p>Making your travel dreams come true, one destination at a time.</p>
            </div>
            <div className="footer-section">
              <h4>Quick Links</h4>
              <ul>
